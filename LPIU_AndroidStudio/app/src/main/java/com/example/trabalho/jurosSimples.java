    ...
    private final View.OnClickListener calcularJuros = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mes.isChecked()) {
                ...
                Toast toast = Toast.makeText(jurosSimples.this, "É preciso selecionar uma opção!", Toast.LENGTH_LONG);
                toast.show();
            }
            ...
            if (capital.getText().toString().equals("")) {
                Toast.makeText(jurosSimples.this, "Favor preencher o CAPITAL!", Toast.LENGTH_LONG).show();
            } else if (taxa.getText().toString().equals("")) {
                Toast.makeText(jurosSimples.this, "Favor preencher a TAXA!", Toast.LENGTH_LONG).show();
            } else if (prazo.getText().toString().equals("")) {
                Toast.makeText(jurosSimples.this, "Favor preencher o PRAZO!", Toast.LENGTH_LONG).show();
            }else if(tempo == null){
                Toast.makeText(jurosSimples.this, "Favor preencher o TEMPO da taxa!", Toast.LENGTH_LONG).show();
            } else {
                Intent next = new Intent(jurosSimples.this, resultadoJSimples.class);
